...
(function(undefined) {
  ...
  describe('Class factory', function classFactorySpecs() {
    ...
    describe('minification', function minificationSpecs() {
      it('should use the provided class name', function providedClassName() {
        // given
        ...
        clazz(className, SomeClass);

        // when
        var Extending = clazz(function Extending() {
          this.extend = 'MyClass';
        });
        var extendedClass = new Extending();

        // then
        expect(extendedClass.name).toEqual('Test');
      });
    });
  });
}());
